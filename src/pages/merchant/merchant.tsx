...
import * as utils from "../../utils/filter/merchants";
...
const Merchants = () => {
  ...
  const { data, refetch } = useQuery({
    queryKey: ["merchantList", { pageNumber, pageSize, ...filters }],
    queryFn: async () => {
  ...
  const columns = useMemo(() => {
    return utils.columns({
      hasEditPermission: checkAccessRight(accesses, "update", "merchant"),
      hasDeletePermission: checkAccessRight(accesses, "delete", "merchant"),
      t,
