...
import * as utils from "../../../utils/filter/ranking.general";
import { checkAccessRight } from "../../../utils/common/accessUtils";
import FilterData from "../../../components/common/FilterData";
import ModalConfirm from "../../../components/ModalConfirm";
import { toast } from "react-toastify";
import RankingAction from "./RankingAction";

const RankingGeneral = ({ programId }: { programId: any }) => {
  ...
  const { data, refetch } = useQuery({
    queryKey: ["rankingList", { programId, pageNumber, pageSize, ...filters }],
    queryFn: async () => {
      const response: any = await TierApi.getWithPagination(
